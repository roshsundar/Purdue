...
void bb_write_bit(int val) {
    ...
    if (val == 0) {GPIOB -> BSRR |= GPIO_BSRR_BR_15;}
    else {GPIOB -> BSRR |= GPIO_BSRR_BS_15;}
...
void bb_write_halfword(int halfword) {
    ...
    bb_write_bit((halfword & 0b1000000000000000));
    bb_write_bit((halfword & 0b0100000000000000));
    bb_write_bit((halfword & 0b0010000000000000));
    bb_write_bit((halfword & 0b0001000000000000));
    bb_write_bit((halfword & 0b0000100000000000));
    bb_write_bit((halfword & 0b0000010000000000));
    bb_write_bit((halfword & 0b0000001000000000));
    bb_write_bit((halfword & 0b0000000100000000));
    bb_write_bit((halfword & 0b0000000010000000));
    bb_write_bit((halfword & 0b0000000001000000));
    bb_write_bit((halfword & 0b0000000000100000));
    bb_write_bit((halfword & 0b0000000000010000));
    bb_write_bit((halfword & 0b0000000000001000));
    bb_write_bit((halfword & 0b0000000000000100));
    bb_write_bit((halfword & 0b0000000000000010));
    bb_write_bit((halfword & 0b0000000000000001));
...
void setup_dma(void) {
    ...
    DMA1_Channel5 -> CCR &= ~DMA_CCR_MSIZE; DMA1_Channel5 -> CCR |= DMA_CCR_MSIZE_0;
    DMA1_Channel5 -> CCR &= ~DMA_CCR_PSIZE; DMA1_Channel5 -> CCR |= DMA_CCR_PSIZE_0;
...
void spi1_setup_dma(void) {
    RCC -> AHBENR |= RCC_AHBENR_DMA1EN;
        ...
        DMA1_Channel3 -> CCR &= ~DMA_CCR_MSIZE; DMA1_Channel3 -> CCR |= DMA_CCR_MSIZE_0;
        DMA1_Channel3 -> CCR &= ~DMA_CCR_PSIZE; DMA1_Channel3 -> CCR |= DMA_CCR_PSIZE_0;
